...
class _QuoteModalState extends State<QuoteModal> {
  ...
  void initState() {
    super.initState();
    // Get a new random quote every time the modal is opened
  ...
  Widget build(BuildContext context) {
    ...
    final horizontalPadding = context.widthPct(5);
    final verticalPadding = context.heightPct(2);
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          padding: EdgeInsets.symmetric(
                            ...
                            vertical: context.responsiveSpacing(10),
                          ),
