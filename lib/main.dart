...
void main() async {
  ...
  FlutterError.onError = (FlutterErrorDetails details) {
    ...
    if (exceptionString.contains('google_fonts') &&
      ...
      if (kDebugMode) {
        debugPrint('Font loading error (network issue) - using system fonts: ${details.exception}');
      }
  ...
  runZonedGuarded(() async {
    ...
    if (errorString.contains('google_fonts') &&
      ...
      if (kDebugMode) {
        debugPrint('Unhandled font loading error (network issue) - using system fonts: $error');
      }
      return; // Don't crash the app
    }
